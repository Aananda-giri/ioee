...
# http://127.0.0.1:8000/person/student/SEC076BCE002/
def student(request, ioe_roll_no):
    formats = ['jpg', 'jpeg', 'png']
    urls=[]
    for i in range(3020,3040):
        for format in formats:
            urls.extend(['https://exam.ioe.edu.np/Images/StudentCurrentImage/{}/{}.{}'.format(i, ioe_roll_no, format)])
    print(urls)
    return render(request, 'person/ioe_images.html', {'urls':urls})
