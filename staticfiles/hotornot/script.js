...
var faculties = ['BCE', 'BCT', 'BAR', 'BME', 'BEL', 'BEI', 'BCH', 'BIE', 'BAM', 'BGE', 'BAG',]
...
function create_image_divs(){
  ...
  div1.setAttribute('class','col-md-6 img-responsive mb-2');
  ...
  let div2 = document.createElement('div');
    div2.setAttribute('class','col-md-6 img-responsive mt-2');
